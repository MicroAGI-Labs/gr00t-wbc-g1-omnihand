...
to `IDLE_BASE_POSE` (elbows slightly behind the torso for balance, forearms at
a physical 90-degree bend, and neutral wrists so the hands remain parallel to
the forearms while the palms face each other). The operator
