...
to `IDLE_BASE_POSE` (upper arms down, forearms forward at 90-degree elbows,
and neutral wrists so the hands remain parallel to the forearms while the
palms face each other). The operator
